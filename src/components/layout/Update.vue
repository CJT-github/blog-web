<template>
  <DialogRoot v-model:open="open">
    ...
    <DialogPortal>
      ...
      >
        <form autocomplete="off" id="update">
          ...
          <input type="hidden" name="hidden" value="" autofocus />
          <div class="p-[25px]">
            ...
            <div class="mt-[25px] flex justify-end">
              <button
                class="hover:bg-green5 inline-flex h-[35px] items-center justify-center rounded-[4px] px-[15px] font-semibold leading-none focus:shadow-[0_0_0_2px] ml-2"
                @click="requestFn"
                v-loading="isLoading"
                tabindex="-1"
              >
            ...
            <DialogClose
              class="text-grass11 absolute top-[10px] right-[10px] inline-flex h-[25px] w-[25px] appearance-none items-center justify-center rounded-full focus:outline-none"
              aria-label="Close"
            >
              <Icon icon="lucide:x" />
            </DialogClose>
